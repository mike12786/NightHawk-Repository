...
public class PlayServicesHelper {
    ...
    private IRegGCM callbackReg;
    private String regId;

    public PlayServicesHelper(Activity activity) {
        this.activity = activity;
        this.callbackReg = (IRegGCM) activity;
        checkPlayService();
    }
    ...
    private void checkPlayService() {
        ...
        if (checkPlayServices()) {
            ...
            if (regId.isEmpty()) {
                registerInBackground((IRegGCM)activity);
            }else
                callbackReg.onGcmRegSuccess();
        } else {
    ...
    public static String getRegistrationIdProperty(Context context){
     ...
     * shared preferences.
     */
    private void registerInBackground(final IRegGCM callbackReg) {
     ...
     */
    private void subscribeToPushNotifications(String registrationID, final IRegGCM callbackReg) {
        ...
        QBPushNotifications.createSubscription(subscription, new QBEntityCallback<ArrayList<QBSubscription>>() {
            ...
            public void onError(QBResponseException error) {
                ...
                callbackReg.onGcmRegFailed("" + error.getErrors());
            }
        });
    }
